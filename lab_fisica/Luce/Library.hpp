...
// ============================================================================
template <typename T> void linReg(std::vector<T> x,std::vector<T> y,T * m, T * q){
...
// Questa funzione fa la regressione lineare data due vector ascisse e ordinate
// ============================================================================
template <typename T>void linRegPes(std::vector<T> x,std::vector<T> y, std::vector<T> err_y,T * m, T * q){
...
void Parse( std::string filename, std::vector<double> & myx, std::vector<double> & myy ) {
  ...
  std::cout<< " new ParseFile: vector size = " << myx.size() << " " << myy.size() << '\n';  
