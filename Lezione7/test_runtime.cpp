...
int main(){
    ...
    plt.plot(prec,error,"Midpoint Real",Gnuplot::LineStyle::LINESPOINTS);
    ...
    plt.plot(prec,error,"Simpson Real",Gnuplot::LineStyle::LINESPOINTS);
    ...
    plt.plot(prec,error,"Trapezoide Real",Gnuplot::LineStyle::LINESPOINTS);
